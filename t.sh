...
if [ $(Rule2) == false ]; then
    ...
    "tensorflow")
        echo "Tensorflow"
        NV_GPU=0,1,2,3 nvidia-docker run -idt --name $Container -p 22 -p 8888 -p 8080 --pid=host -v /home/lab120/user_data/$Name:/workspace/$Name/ \
    ...
    "pytorch")
        echo "Pytorch"
        NV_GPU=0,1,2,3 nvidia-docker run -idt --name $Container -p 22 -p 8888 -p 8080 -v /home/lab120/user_data/$Name:/workspace/$Name/ \
            -v /raid/DataSet/$Name:/workspace/DataSet -v /raid/ShareDataSet:/workspace/Share -e "PASSWORD=$Password" $Image bash
        RunInit
        Installnvtop
        InstallCodeServer
        StartService
    ...
    "matlab")
        ...
        NV_GPU=0,1,2,3 nvidia-docker run -idt --name $Container -p 22 -p 5901 -p 6080 \
            ...
            -v /raid/ShareDataSet:/home/matlab/Documents/MATLAB/ShareDataSet/ $Image bash
        RunInit
        Installnvtop
        # ChangeResolution
        StartService
